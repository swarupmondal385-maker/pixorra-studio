        ...
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-5">
            <a href="#top" className="inline-block group">
              <img src={logoFull} alt="Pixorra" className="h-24 object-contain group-hover:scale-105 transition-transform duration-300" />
            </a>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="mt-5 space-y-3 text-ink/75">
              ...
              <li>
                <a href="/donate" className="inline-flex items-center gap-2 hover:text-ink hover:translate-x-1 transition-transform font-semibold">
          ...
          <div className="lg:col-span-4">
            ...
            <ul className="mt-5 space-y-3 text-ink/85">
              ...
              <li className="flex items-center gap-3 text-sm text-ink/70 px-1"><MapPin className="h-4 w-4 text-pixel-pink" /> Mumbai, Maharashtra, India</li>
              <li className="flex items-center gap-3 text-sm text-ink/70 px-1"><Clock className="h-4 w-4 text-pixel-purple" /> Mon–Sat · 10 AM – 8 PM IST</li>
            </ul>
          </div>
        </div>
