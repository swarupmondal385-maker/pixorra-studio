...
export function FinalCTA() {
  return (
    <section className="py-24 md:py-36 bg-background relative overflow-hidden">
      ...
      <div
        className="absolute -bottom-24 right-1/4 h-72 w-72 rounded-full bg-pixel-cyan/15 blur-3xl blob"
        style={{ animationDelay: "3s" }}
      />
      <div className="absolute top-20 left-10 h-3 w-3 bg-pixel-yellow sparkle-pulse" />
      <div
        className="absolute top-40 right-16 h-2 w-2 bg-pixel-purple sparkle-pulse"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute bottom-32 left-20 h-2.5 w-2.5 bg-pixel-green sparkle-pulse"
      ...
      <div className="relative max-w-5xl mx-auto px-5 md:px-8 text-center reveal">
        ...
        <p className="mt-7 text-base sm:text-lg md:text-xl text-ink/60 max-w-2xl mx-auto">
          Every lead you don't follow up with goes to a competitor who does. Let's build the system
          that never lets that happen again.
        </p>
        <a
          href="https://wa.me/918927840261?text=Hi%20Pixorra!%20I%20want%20a%20free%20growth%20strategy%20call."
          target="_blank"
          rel="noreferrer"
        ...
        <p className="mt-4 text-sm text-ink/50">
          No card needed · Free strategy call · Zero obligation
        </p>
      </div>
    </section>
  );
