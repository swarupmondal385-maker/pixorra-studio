  ...
  return (
    <section id="top" className="relative pt-28 md:pt-36 bg-gradient-hero overflow-hidden">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute top-40 -right-24 h-96 w-96 bg-pixel-cyan/25 blob"
          style={{ animationDelay: "2s" }}
        />
        <div
          className="absolute bottom-10 left-1/3 h-72 w-72 bg-pixel-yellow/30 blob"
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        ...
        <div
          className="absolute top-40 right-16 h-2 w-2 bg-pixel-yellow sparkle-pulse"
          style={{ animationDelay: "0.5s" }}
        />
        <div
          className="absolute top-60 left-1/3 h-2.5 w-2.5 bg-pixel-cyan sparkle-pulse"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute top-80 right-1/4 h-2 w-2 bg-pixel-purple sparkle-pulse"
          style={{ animationDelay: "1.5s" }}
        />
        <div
          className="absolute top-32 right-10 h-2.5 w-2.5 bg-pixel-green sparkle-pulse"
          style={{ animationDelay: "2s" }}
        />
        <div
          className="absolute top-[28rem] left-12 h-2 w-2 bg-pixel-orange sparkle-pulse"
          style={{ animationDelay: "0.8s" }}
        />
        <div
          className="absolute top-[22rem] right-1/3 h-3 w-3 bg-pixel-blue sparkle-pulse"
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 hidden md:block">
        ...
        <div
          className="absolute top-44 right-[10%] text-3xl drift"
          style={{ animationDelay: "1.5s" }}
        >
          🚀
        </div>
        <div
          className="absolute top-[26rem] left-[6%] text-3xl drift"
          style={{ animationDelay: "3s" }}
        >
          💖
        </div>
        <div
          className="absolute top-[30rem] right-[8%] text-2xl drift"
      ...
      <div className="relative max-w-7xl mx-auto px-5 md:px-8">
        ...
        <div className="relative text-center max-w-5xl mx-auto reveal">
          ...
          <div className="mt-6 flex justify-center">
            <div className="relative h-32 w-32 md:h-36 md:w-36">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="orbit" style={{ "--orbit-r": "78px" } as CSSProperties}>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div
                  className="orbit"
                  style={{ "--orbit-r": "78px", animationDelay: "-3s" } as CSSProperties}
                >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div
                  className="orbit"
                  style={{ "--orbit-r": "78px", animationDelay: "-6s" } as CSSProperties}
                >
          ...
          <p className="mt-6 text-lg md:text-xl text-ink/65 max-w-3xl mx-auto">
            We build premium websites &amp; automated systems that turn strangers into customers —
            while you sleep.
          </p>
            ...
            <div className="relative rounded-2xl border-2 border-ink shadow-pixel overflow-hidden group cursor-pointer hover:-translate-y-1 hover:translate-x-0.5 transition-transform glass-card glass-shine">
              <div className="aspect-video bg-pixel-purple relative flex items-center justify-center">
                ...
                <div className="absolute top-3 right-3 h-7 px-3 rounded-full bg-foreground text-background text-[10px] font-bold flex items-center gap-1.5 border border-background/20">
                  <span className="h-1.5 w-1.5 rounded-full bg-pixel-pink animate-pulse" />2 min
                  watch
                </div>
              </div>
              <div className="p-4 flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-xs uppercase tracking-wider text-ink/50 font-bold">
                    Watch Demo Video
                  </div>
                  <div className="text-sm font-semibold text-ink truncate">
                    See how Pixorra delivers in 7 days
                  </div>
                </div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
            <a
              href="#demo"
              className="group inline-flex items-center gap-2 h-14 px-7 rounded-full bg-yellow-cta text-ink font-bold border-2 border-ink shadow-pixel hover:-translate-y-0.5 hover:translate-x-0.5 transition-transform"
            >
              Book My Free Demo{" "}
            ...
            <a
              href="#work"
              className="inline-flex items-center gap-2 h-14 px-7 rounded-full bg-card border-2 border-ink text-ink font-bold hover:bg-pixel-yellow transition-colors shadow-pixel"
            >
            ...
            <div className="flex items-center gap-2">
              <div className="flex -space-x-2">
                {[
                  ...
                  <div
                    key={i}
                    className={`h-8 w-8 rounded-full ring-2 ring-white border border-ink flex items-center justify-center text-xs font-bold text-white ${bg}`}
                  >
                    {i}
                  </div>
                ))}
              ...
              <span className="text-ink/70">
                <b className="text-ink">150+</b> local businesses served
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="reveal">
            ...
            <p className="mt-5 text-ink/65 text-lg">
              Your website should be your hardest-working salesperson — open 24/7, closing leads
              while you sleep.
            </p>
            <ul className="mt-7 space-y-3">
              {[
                ...
                <li
                  key={b.t}
                  className="flex items-center gap-3 bg-card border-2 border-ink rounded-2xl px-4 py-3 shadow-pixel"
                >
                  <span
                    className={`h-9 w-9 rounded-xl ${b.c} border-2 border-ink flex items-center justify-center text-lg`}
                  >
                    {b.e}
                  </span>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-8 inline-flex items-center gap-2 h-12 px-6 rounded-full bg-pixel-green text-white font-bold border-2 border-ink shadow-pixel hover:-translate-y-0.5 transition"
            >
          ...
          <div className="relative reveal group perspective-1200 mx-auto w-full max-w-[34rem]">
            <div
              aria-hidden
              className="absolute -inset-6 -z-10 rounded-[2rem] bg-gradient-rainbow opacity-20 blur-2xl spin-slower group-hover:opacity-35 group-hover:blur-xl transition-all duration-500"
            />
              ...
              <div className="rounded-[1.6rem] border border-border bg-card shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] overflow-hidden">
                ...
                <div className="p-4">
                  <div className="flex items-center justify-between gap-3">
                    <div className="h-5 w-20 rounded-md bg-gradient-pixorra wiggle" />
                    <div className="flex gap-2">
                      <div className="h-2 w-12 rounded skeleton-pulse bg-muted" />
                      <div
                        className="h-2 w-12 rounded skeleton-pulse bg-muted"
                  ...
                  <div className="mt-5 grid grid-cols-5 gap-3">
                    <div className="col-span-3">
                      <div
                        className="h-2.5 w-16 rounded skeleton-pulse bg-muted mb-2"
                        style={{ animationDelay: "0.1s" }}
                      />
                      <div
                        className="h-5 w-full rounded skeleton-pulse bg-muted"
                        style={{ animationDelay: "0.2s" }}
                      />
                      <div
                        className="mt-1.5 h-5 w-4/5 rounded skeleton-pulse bg-muted"
                        style={{ animationDelay: "0.3s" }}
                      />
                      <div className="mt-3 space-y-1">
                        <div
                          className="h-1.5 w-full rounded skeleton-pulse bg-muted"
                          style={{ animationDelay: "0.4s" }}
                        />
                        <div
                          className="h-1.5 w-11/12 rounded skeleton-pulse bg-muted"
                          style={{ animationDelay: "0.5s" }}
                        />
                      </div>
                      <div className="mt-4 flex gap-2">
                        <div className="h-8 w-24 rounded-full bg-gradient-pixorra border-2 border-ink" />
                        <div className="h-8 w-20 rounded-full border-2 border-ink" />
                      </div>
                    </div>

                    <div className="col-span-2 aspect-square rounded-2xl bg-gradient-pixorra relative overflow-hidden border-2 border-ink flex items-center justify-center">
                      <svg
                        className="h-8 w-8 text-white/80 loading-spin"
                        viewBox="0 0 24 24"
                        fill="none"
                      >
                        <circle
                      ...
                      <div className="absolute bottom-3 left-3 right-3 h-14 rounded-xl bg-background/90 backdrop-blur flex items-center px-3 gap-2 border border-ink">
                        <div className="h-8 w-8 rounded-lg bg-pixel-pink" />
                        <div className="flex-1 space-y-1">
                          <div
                            className="h-1.5 w-20 rounded skeleton-pulse bg-muted"
                            style={{ animationDelay: "0.6s" }}
                          />
                          <div
                            className="h-1.5 w-14 rounded skeleton-pulse bg-muted"
                  ...
                  <div className="mt-5 grid grid-cols-3 gap-3">
                    {[...Array(3)].map((_, i) => (
                      ...
                      >
                        <div
                          className="h-5 w-5 rounded skeleton-pulse bg-muted"
                          style={{ animationDelay: `${0.9 + i * 0.2}s` }}
                        />
                        <div
                          className="mt-2 h-2 w-full rounded skeleton-pulse bg-muted"
                          style={{ animationDelay: `${1.0 + i * 0.2}s` }}
                        />
                        <div
                          className="mt-1 h-1.5 w-3/4 rounded skeleton-pulse bg-muted"
            ...
            <div className="absolute -top-5 -left-4 md:-left-10 hidden md:block rounded-2xl glass-card shadow-pixel border-2 border-ink p-4 float-soft wobble group-hover:-translate-y-3 group-hover:-rotate-3 transition-all duration-300">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-[10px] uppercase tracking-wider text-ink/50 font-bold">
                    Organic Traffic
                  </div>
                  <div className="font-display text-xl font-bold text-ink group-hover:text-gradient-pixorra transition-all">
                    +320%
                  </div>
                </div>
              </div>
            ...
            <div
              className="absolute -bottom-5 -right-3 md:-right-10 hidden md:block rounded-2xl glass-card shadow-pixel border-2 border-ink p-4 float-soft wobble group-hover:-translate-y-2 group-hover:rotate-3 transition-all duration-300"
              style={{ animationDelay: "1.2s" }}
            >
              <div className="flex items-center gap-3">
                <div
                  className="h-10 w-10 rounded-xl bg-pixel-pink border-2 border-ink flex items-center justify-center sparkle-pulse group-hover:scale-110 transition-transform"
                  style={{ animationDelay: "0.6s" }}
                >
            ...
            <div
              className="absolute -top-6 -right-4 hidden md:flex h-16 w-16 rounded-full bg-pixel-yellow border-2 border-ink shadow-pixel items-center justify-center wobble group-hover:scale-110 group-hover:rotate-12 transition-transform duration-300"
              style={{ animationDelay: "0.4s" }}
            >
              <span className="font-display font-bold text-ink text-xs leading-tight text-center">
                FREE
                <br />
                DEMO
              </span>
