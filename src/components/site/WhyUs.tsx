...
const REASONS = [
  {
    ...
    desc: "Most agencies take 2 months. We go live in ten days — without cutting corners on quality.",
    pop: "card-pop-yellow",
    bg: "bg-pixel-yellow",
  },
  {
    ...
    desc: "Honest packages built for local founders. No ₹1 lakh setup fees for a basic brochure site.",
    pop: "card-pop-pink",
    bg: "bg-pixel-pink",
  },
  {
    icon: Target,
    title: "Designed for Leads, Not Awards",
    desc: "Every button, headline and image is placed with one goal: get the phone ringing.",
    pop: "card-pop-cyan",
    bg: "bg-pixel-cyan",
  },
  {
    ...
    desc: "Text us anytime. Broken link, new offer, small tweak — consider it done, the same day.",
    pop: "card-pop-purple",
    bg: "bg-pixel-purple",
  },
];
        ...
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-5 reveal">
            ...
            <p className="mt-5 text-lg text-ink/60">
              We're not a call-centre agency. You'll speak to the same team that designs, builds and
              supports your site — for as long as you have it.
            </p>
          </div>
          <div className="lg:col-span-7 grid sm:grid-cols-2 gap-6">
            {REASONS.map(({ icon: Icon, title, desc, pop, bg }, i) => (
              ...
              >
                <div
                  className={`inline-flex h-12 w-12 items-center justify-center rounded-2xl border-2 border-ink ${bg}`}
                >
