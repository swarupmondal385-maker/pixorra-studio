      ...
      <section id="our-mission" className="relative py-20 md:py-32 bg-background overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-5 md:px-8">
          <div className="text-center reveal max-w-3xl mx-auto">
            <span className="inline-flex items-center gap-2 rounded-full bg-card border-2 border-ink px-4 py-1.5 text-[11px] font-bold tracking-[0.2em] text-ink uppercase shadow-pixel"><Heart className="h-3 w-3 text-pixel-pink" fill="currentColor" /> Our Mission</span>
        ...
        <div className="relative max-w-6xl mx-auto px-5 md:px-8">
          ...
          <div className="mt-14 grid md:grid-cols-2 gap-6">
            {HOSPITAL_SECTION.map(({ icon: Icon, title, desc, c, stat }, i) => (
              <div key={title} className="reveal relative rounded-3xl bg-card border-2 border-ink shadow-pixel p-7 md:p-9 flex gap-5 hover:-translate-y-1 transition-transform" style={{ animationDelay: `${i * 80}ms` }}>
      ...
      <section id="donate-now" className="relative py-20 md:py-32 bg-background overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-5 md:px-8">
          <div className="text-center reveal">
            <span className="inline-flex items-center gap-2 rounded-full bg-card border-2 border-ink px-4 py-1.5 text-[11px] font-bold tracking-[0.2em] text-ink uppercase shadow-pixel"><IndianRupee className="h-3 w-3 text-pixel-green" /> Choose Your Impact</span>
          ...
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-3 reveal">
            {DONATION_TIERS.map((t, i) => (
               <button key={t.amount} onClick={() => setSelected(i)} className={`relative rounded-2xl border-2 border-ink p-5 text-center transition-all duration-200 hover:-translate-y-1 ${selected === i ? "bg-card shadow-pixel scale-105" : "bg-card/70 hover:bg-card hover:shadow-pixel"}`}>
            ...
            <div className="rounded-3xl bg-cream border-2 border-ink shadow-pixel p-6 md:p-8">
              ...
              <div className="rounded-2xl bg-card border-2 border-dashed border-ink/20 p-5">
                ...
                <div className="flex items-center justify-between gap-3 bg-cream rounded-xl border-2 border-ink p-4">
                  ...
                  <button onClick={handleCopy} className={`inline-flex items-center gap-1.5 h-10 px-4 rounded-full border-2 border-ink text-sm font-bold transition-all ${copied ? "bg-pixel-green text-ink" : "bg-foreground text-background hover:-translate-y-0.5"}`}>
      ...
      <section className="relative py-20 md:py-28 bg-gradient-pixorra overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-5 md:px-8 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="#donate-now" className="inline-flex items-center gap-2 h-14 px-8 rounded-full bg-card text-ink font-bold border-2 border-ink shadow-pixel hover:-translate-y-0.5 transition-transform"><Heart className="h-5 w-5 text-pixel-pink" fill="currentColor" /> Donate Now</a>
            <a href="/" className="inline-flex items-center gap-2 h-14 px-8 rounded-full bg-foreground text-background font-bold border-2 border-ink shadow-pixel hover:-translate-y-0.5 transition-transform">Back to Home <ArrowRight className="h-5 w-5" /></a>
          </div>
        </div>
      </section>
    </main>
